...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(14,116,144,0.08),_transparent_30%),linear-gradient(135deg,_#f8fbff_0%,_#f3f7ff_100%)] p-3 md:p-6">
            <div className="mx-auto flex max-w-7xl flex-col gap-4 lg:flex-row">
                <div className="lg:hidden">
                    <button
                        onClick={() => setMobileSidebarOpen((prev) => !prev)}
                        className="mb-2 rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm font-semibold text-slate-700 shadow-sm"
                    >
